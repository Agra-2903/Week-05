package org.ioprogramming.intermediatelevel.modifyfile;
...
public class ModifyFile {
    public static void main(String[] args) {
        String inputFilePath = "src/main/java/org/ioprogramming/intermediatelevel/modifyfile/employees.csv";
        String outputFilePath = "src/main/java/org/ioprogramming/intermediatelevel/modifyfile/newEmployees.csv";
